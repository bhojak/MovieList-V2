...
class MovieViewModel @Inject constructor(private val movieRepo: MovieRepo): ViewModel() {
    ...
    private fun getPopularMoviesFromRoom(){
    ...
    private fun getTopRatedMoviesFromRoom(){
        viewModelScope.launch(Dispatchers.IO) {
    ...
    private fun getNowPlayingMoviesFromRoom(){
        viewModelScope.launch(Dispatchers.IO) {
    ...
    private fun getUpcomingMoviesFromRoom(){
        viewModelScope.launch(Dispatchers.IO) {
    ...
    private fun storeTopRatedMovies(){
        viewModelScope.launch {
    ...
    private fun storeNowPlayingMovies(){
        viewModelScope.launch {
    ...
    private fun storeUpcomingMovies(){
        viewModelScope.launch {
